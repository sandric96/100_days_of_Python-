...
if choice1 == "left":
    ...
    if choice2 == "wait":
        #continue in the game.
        choice3 = input("You arrive at the isalnd unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which color do you choose?").lower()
        if choice3 == "red":
            print("It's room full of fier. Game Over!")
        elif choice3 == "yellow":
